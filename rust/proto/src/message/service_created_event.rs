...
mod test {
    ...
    fn no_serial() {
        let serialized = [
            19, 0x31, 0x0a, 0xce, 0xa9, 0x6d, 0x9e, 0x4f, 0x80, 0xad, 0x7d, 0x29, 0xa0, 0x11, 0x32,
            ...
            0xb2, 0xcd, 0x89, 0xda, 0x0d, 0xda, 0x17, 0x79, 0,
        ];
    ...
    fn serial() {
        let serialized = [
            ...
            0x53, 0xae, 0xbb, 0x10, 0xfc, 0x2d, 0x4c, 0x9e, 0xe0, 0x5b, 0x4a, 0x31, 0x90, 0xf8,
            0x81, 0x90, 0x80, 0x91, 0xd0, 0x28, 0x54, 0x37, 0xe9, 0x74, 0xe5, 0x91, 0x48, 0x23,
            0xb2, 0xcd, 0x89, 0xda, 0x0d, 0xda, 0x17, 0x79, 1, 2,
        ];
