...
mod test {
    ...
    fn cookie() {
        let serialized = [
            28, 1, 0, 0xb7, 0xc3, 0xbe, 0x13, 0x53, 0x77, 0x46, 0x6e, 0xb4, 0xbf, 0x37, 0x38, 0x76,
            0x52, 0x3d, 0x1b,
        ];
    ...
    fn service() {
        let serialized = [
            28, 2, 1, 0xb7, 0xc3, 0xbe, 0x13, 0x53, 0x77, 0x46, 0x6e, 0xb4, 0xbf, 0x37, 0x38, 0x76,
            0x52, 0x3d, 0x1b, 0x52, 0x8c, 0x0b, 0x73, 0x0b, 0xba, 0x49, 0xa7, 0xbf, 0xc7, 0x0f,
            0xd4, 0xbc, 0x94, 0x42, 0x71,
        ];
