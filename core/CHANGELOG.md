...
- Bump MSRV to 1.94.1 and switch to Rust edition 2024.
- Update the bytes crate to 1.11.1 to fix [RUSTSEC-2026-0007].
...
- Add introspection support for newtypes.
- Add `Buffered<T>` adapter for transports, which adds an unbounded buffer to the sender side.
...
- Guard `Packetizer` against messages that supposedly have a length < 4.
...
[0.14.0]: https://github.com/dennis-hamester/aldrin/releases/tag/aldrin-core-0.14.0
[0.13.0]: https://github.com/dennis-hamester/aldrin/releases/tag/aldrin-core-0.13.0
