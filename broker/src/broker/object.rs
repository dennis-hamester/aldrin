...
impl Object {
    pub(crate) fn new(conn_id: ConnectionId, cookie: ObjectCookie) -> Self {
        Self {
            conn_id,
            svcs: HashSet::new(),
            cookie,
    ...
    pub(crate) fn cookie(&self) -> ObjectCookie {
        self.cookie
    }
    ...
    pub(crate) fn services(&self) -> impl Iterator<Item = ServiceCookie> {
