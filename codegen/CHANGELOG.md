...
- `Generator` is now `Copy` and `Clone`.
- Rename `Generator::generate_rust()` to just `rust()`.
- The `register_introspection()` function is now suffixed with the schema's name.
...
[0.14.0]: https://github.com/dennis-hamester/aldrin/releases/tag/aldrin-codegen-0.14.0
[0.13.0]: https://github.com/dennis-hamester/aldrin/releases/tag/aldrin-codegen-0.13.0
