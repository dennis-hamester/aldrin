...
impl SubscribeAllEventsResult {
    pub(crate) fn to_core(self, _ctx: &Context) -> message::SubscribeAllEventsResult {
        match self {
            Self::Ok => message::SubscribeAllEventsResult::Ok,
            Self::InvalidService => message::SubscribeAllEventsResult::InvalidService,
            Self::NotSupported => message::SubscribeAllEventsResult::NotSupported,
        }
    }
