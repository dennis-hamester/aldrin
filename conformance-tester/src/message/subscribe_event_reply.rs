...
impl SubscribeEventResult {
    pub(crate) fn to_core(self, _ctx: &Context) -> message::SubscribeEventResult {
        match self {
            Self::Ok => message::SubscribeEventResult::Ok,
            Self::InvalidService => message::SubscribeEventResult::InvalidService,
        }
    }
