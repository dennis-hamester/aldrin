...
impl StartBusListenerResult {
    pub(crate) fn to_core(self, _ctx: &Context) -> message::StartBusListenerResult {
        match self {
            Self::Ok => message::StartBusListenerResult::Ok,
            Self::InvalidBusListener => message::StartBusListenerResult::InvalidBusListener,
            Self::AlreadyStarted => message::StartBusListenerResult::AlreadyStarted,
        }
    }
