...
- `Call<Args, T, E>`, `Promise<T, E>` and `PendingReply<T, E>` now have set `E = Infallible` set as
...
[0.14.0]: https://github.com/dennis-hamester/aldrin/releases/tag/aldrin-0.14.0
[0.13.0]: https://github.com/dennis-hamester/aldrin/releases/tag/aldrin-0.13.0
...
[0.4.1]: https://github.com/dennis-hamester/aldrin/releases/tag/aldrin-0.4.1
